      ...
      >
        ...
        <el-table-column label="分类名称" min-width="200">
          <template slot-scope="scope">
            <el-input clearable v-model="scope.row.name" placeholder="必填项"/>
          </template>
        </el-table-column>
        ...
        <el-table-column label="操作" width="200">
         <template slot-scope="scope">
            <el-button type="text" @click="childAdd(scope.row)" v-if="scope.row.isShow" :disabled="!scope.row.id">添加子类</el-button>
            <el-popover
              width="100"
              placement="top"
